  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Image Serving</h1>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">Image Transformations:</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">Advanced Parameters:</h2>
            <div className="space-y-2 text-sm">
              <div>
                <code className="bg-gray-200 px-2 py-1 rounded text-xs">
                  /image.jpg?width=400
          ...
          <div className="pt-4 border-t">
            <p className="text-xs text-gray-500">
              Admin panel available at <code className="bg-gray-200 px-1 py-0.5 rounded">/manage</code>
            </p>
          </div>
        </div>
      </div>
